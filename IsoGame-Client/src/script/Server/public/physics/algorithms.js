...
(function (MainModule) {
    var SpatialGrid = (function () {
        function SpatialGrid(minX, maxX, minY, maxY, cellSize, entities) {
        ...
        SpatialGrid.prototype.update = function () {
        ...
        SpatialGrid.prototype.queryForCollisionPairs = function () {
        ...
        SpatialGrid.prototype.aabb2DIntersection = function (objA, objB) {
    ...
    MainModule.SpatialGrid = SpatialGrid;
